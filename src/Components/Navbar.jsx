...
import { useState } from 'react';
  ...
  return (
    <div style={{ zIndex: 1000,backgroundImage: 'linear-gradient(to right, #490066, #000039)' }} className='sticky top-0 bg-purple-900 flex flex-col md:flex-row items-center justify-between mb-4 mt-7'>
